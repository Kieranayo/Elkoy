...
if (playerside isEqualTo civillian && !license_civ_anvil) exitwith{hint "You cannot impound without the license!";};
...
if (count crew _vehicle isEqualTo 0) then {
    ...
    waitUntil {!life_impound_inuse};
     if (playerSide in [west,independent,civillian]) then {
