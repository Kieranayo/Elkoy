...
_role1 = "Welcome to Elkoy Roleplay";
_role1names = ["A Framework by Tonic"];
_role2 = "Improved upon";
_role2names = ["the Elkoy Roleplay Development Team"];
_role3 = "Visit Our Website at";
_role3names = ["elkoy.co.uk"];
_role4 = "Join Our Teamspeak at";
_role4names = ["ts.elkoy.net"];
_role5 = "Please enjoy your stay with us";
