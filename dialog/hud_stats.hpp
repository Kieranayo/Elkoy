/*
	...
	Usage: ONLY To be used by ElkoyRP otherwise contact deadlesszombie/Neil Smith on www.altisliferpg.com
*/

//this is just for us to remember, or we can actually use these!
