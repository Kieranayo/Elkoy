...
/* System Settings */
    ...
    sendtoJail_locations[] = { "cop_jail_1", "police_hq_2", "cop_spawn_3", "cop_spawn_5", "Correctional_Facility" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    /* Paycheck & Ban System Configurations */
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F", "B_CTRG_Heli_Transport_01_tropic_F", "I_Heli_Transport_02_F", "B_Plane_Fighter_01_F", "I_Heli_light_03_dynamicLoadout_F", "I_Heli_light_03_F", "B_Heli_Transport_03_F", "O_T_LSV_02_unarmed_F", "I_Quadbike_01_F", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_F", "I_MRAP_03_F"}; //Vehicles that can only be rented and not purchased. (Last only for the session)
    ...
    vehicle_civ_impound_multiplier = .1; //Anvil Impounding
